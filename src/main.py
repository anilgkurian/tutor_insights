...
def startup_event():
    ...
    scheduler.add_job(run_feedback_generation, 'cron', day_of_week='sat', hour=11,minute=30, timezone='Asia/Kolkata')
    ...
    scheduler.add_job(run_question_aggregation, 'cron', day_of_week='sat', hour=11,minute=30, timezone='Asia/Kolkata')
